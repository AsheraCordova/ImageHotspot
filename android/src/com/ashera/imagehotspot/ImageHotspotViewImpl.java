...
public java.util.Map<String, Object> getOnHotspotClickEventObj(Hotspot hotspot,int remainingHotSpots,Map remainingHotSpotsByType) {
	...
	public static ImageTransform fromImageView(ImageView imageView) {
		...
		transform.imageWidth = drawable.getIntrinsicWidth();
		transform.imageHeight = drawable.getIntrinsicHeight();
		return transform;
	}
